...
import { abilityValueType, characterInfoType } from '../../../../config/type'
...
const AcquisitionPoint: React.FC = () => {
    ...
    let abilityValues: Array<any> = useAppSelector((state: any) => state.abilityValues)
    let characterInfo: any = useAppSelector((state: any) => state.characterInfo)
